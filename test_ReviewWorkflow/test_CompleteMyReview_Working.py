# Complete My Review Functionality With Final Review marked as "Approve"
import time
import pyperclip
import pytest
...
def test_Complete_my_approval_Approve_button(test_login):
   ...
   # Apply Filter for Search Request field in My Approval & Review Task section
    try:
       ...
       print("Filters are not applied succesfully in My Approval & Review Task section")
   ...
   # Scroll down and click on Final Review button
    ...
    try:
        ...
        print("Unable to Mark Final Review")
